...
@Slf4j
@Component
public class PerformanceDataTrashcanHandler extends SimpleChannelInboundHandler<PerformanceDataTrashcan> {

    public static PerformanceDataTrashcanHandler nettyUdpServerHandler;
    //
//    @Autowired
//    private JmsMessagingTemplate jmsMessagingTemplate;
    ...
    public PerformanceDataTrashcanHandler() {
    }
...
//        nettyUdpServerHandler.jmsMessagingTemplate = this.jmsMessagingTemplate;
    ...
    @Override
    protected void channelRead0(ChannelHandlerContext ctx, PerformanceDataTrashcan performanceDataTrashcan) {
        log.info("开始接收数据");
